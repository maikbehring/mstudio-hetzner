// @ts-ignore - createServerFileRoute was removed in TanStack Start v1.139
// Server routes are now auto-detected based on file naming convention
// The route will be automatically generated by TanStack Start
...
// NOTE: In TanStack Start v1.139+, server routes are auto-detected based on file naming
// The file name webhooks.mittwald.ts automatically creates route /api/webhooks/mittwald
// We need to use a workaround until we find the correct API
